...
public class TGDateUtils extends DateUtils {
    ...
    public static Date fromString(String from) {
        try {
            return parseDate(from, new String[] {"yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss", "yyyy/MM/dd HH:mm:ss"});
        } catch (Exception e) {
            return null;
        }
    }
